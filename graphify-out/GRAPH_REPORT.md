...
## Corpus Check
- 466 files · ~648,430 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6063 nodes · 9955 edges · 423 communities (402 shown, 21 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 369 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2f12e043`
...
Cohesion: 0.06
Nodes (53): FORM_CONFIGURATION_META, FormConfigurationFormId, FormOverride, PropertyFormConfigStore, checkPasswordPolicy(), ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS (+45 more)

### Community 1 - "AS.tsx / parseYmd()"
Cohesion: 0.05
Nodes (81): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), normalizePathname(), parseAppPath(), viewToPath() (+73 more)
...
Cohesion: 0.05
Nodes (79): class-variance-authority, clsx, Contracts(), ContractsProps, isCompanyNameVariable(), isDateLikeVariable(), isEndDateVariable(), isStartDateVariable() (+71 more)
...
Cohesion: 0.04
Nodes (50): authenticate(), bump_session_version_and_revoke(), change_password(), create_session(), get_password_hash(), get_user_by_id(), get_user_by_username(), AS authentication + authorization + tenant isolation against the relational DB. (+42 more)

### Community 8 - "requestAlertEngine.ts / propertyAlertSettings.ts"
Cohesion: 0.09
Nodes (38): isClPaymentMethod(), requestMatchesAccount(), addCalendarDaysIso(), deriveRequestMealLabelFromRooms(), formatAgendaRowSessionNotes(), requestSectionAddButtonStyle(), normalizeRequestAlerts(), RequestAlert (+30 more)
...
Cohesion: 0.04
Nodes (86): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _assert_upsert_write_access(), _assert_write_access(), _broadcast_change(), _cascade_account_rename_to_requests() (+78 more)
...
Cohesion: 0.16
Nodes (25): getDefaultAccountPerformanceRange(), AccountRequestStats, buildAccountTimeline(), computeAccountMetrics(), filterInquiryToTentativeRequests(), filterOpenBookingRequests(), filterOpenOpportunityLeads(), filterSalesCallsForAccount() (+17 more)
...
Cohesion: 0.09
Nodes (38): accountNameSortKey(), addAccountToContactIndex(), buildSystemDuplicateItems(), compareAccountNames(), isScanDuplicateQueueItemStale(), isScannedContactOnAccount(), normalizeAccountNameKey(), pushSystemDuplicatePair() (+30 more)
...
Cohesion: 0.15
Nodes (35): FilterChips(), Hero(), hexA(), inRange(), legendStyle(), Meter(), monthKey(), PageShell() (+27 more)
...
Cohesion: 0.20
Nodes (25): Card(), fmtCompact(), fmtInt(), fmtMoney(), MiniStat(), money(), RangeTabs(), GRID_2 (+17 more)
...
Cohesion: 0.09
Nodes (26): can_access_property(), Tenant isolation: a non-admin may only access assigned properties., Validate the requested property belongs to the user's tenant scope.      Retur, require_property_access(), auth_me(), change_password(), ChangePasswordRequest, _check_rate_limit() (+18 more)
...
Cohesion: 0.09
Nodes (45): AlertsBell, AlertsBellProps, calculateEventAgendaDays(), calculateNights(), getEventDateWindow(), normalizeRequestTypeKey(), countRequestNights(), countRequestRooms() (+37 more)
...
Cohesion: 0.25
Nodes (17): delta, fmtPct(), groupBy(), num(), sum(), aggReq(), DashboardHubRequestsPage(), requestTime() (+9 more)
...
Cohesion: 0.15
Nodes (22): inDateRangeYMD(), requestOperationalDatesOverlapRange(), segmentLineTotalExTax(), csvEscape(), defaultMonthRange(), formatSar(), initialSavedReports, isEventOrEventRoomsType() (+14 more)
...
Cohesion: 0.39
Nodes (7): HubDataContext, useHubData(), DashboardHubSalesPerformancePage(), isLost(), isWon(), normStatus(), resolveUserKey()
...
Cohesion: 0.11
Nodes (46): e(), calculateAccFinancialsForRequest(), deriveBeoPaymentView(), escapeHtml(), expandAgendaRowVenueOccupancies(), findFirstAgendaVenueConflict(), formatAgendaPackageSummary(), formatAgendaRowCoffeeBreak() (+38 more)

### Community 126 - "propertyAlertSettings.ts"
Cohesion: 0.14
Nodes (23): EmptyState(), LoadingState(), AttachmentGallery(), attachmentKind(), Avatar(), colorsFallbackDim(), DashboardHubFeedPage(), FeedAttachment (+15 more)
...
Cohesion: 0.07
Nodes (46): ALLOWED_ATTR, ALLOWED_TAGS, extractMentionIds(), htmlToPlainText(), MentionUser, RichContent(), RichTextEditor, RichTextEditorHandle (+38 more)
...
Cohesion: 0.13
Nodes (22): API_ORIGIN, apiUrl(), LandingPage(), LandingPageProps, deleteFileLocal(), LocalUploadResult, mediaUrl(), parseErrorText() (+14 more)
...
Cohesion: 0.10
Nodes (26): ACCOUNT_PROFILE_CHART_TABS, AccountProfileChartTab, AccountProfilePerformanceChart(), LY_COLORS, Props, rechartsTooltipThemeProps(), ChartVsCompareControls(), Props (+18 more)
...
Cohesion: 0.22
Nodes (9): AccountSyncBody, AccountUpsertBody, delete_account_endpoint(), get_account_endpoint(), list_accounts_endpoint(), BaseModel, Minimal identity + list fields; extras kept for payload jsonb., Sync envelope: typed identity/list/bool; extras allowed. (+1 more)
...
Cohesion: 0.07
Nodes (39): delete_request(), get_public_feedback_by_token(), Explicit public opt-in: load feedback form by publicToken without auth.      D, Explicit public opt-in: submit feedback answers by publicToken without auth., submit_public_feedback(), get_current_user(), get_current_user_ctx(), Any (+31 more)
...
Cohesion: 0.08
Nodes (48): accountToLead(), contactDisplayName(), leadToAccount(), mergeAccountIntoCrmLead(), resolveAccountOwnerName(), withContactName(), AccountMergeApplyInput, applyAccountMergeInMemory() (+40 more)

### Community 283 - "GSAP Plugins"
Cohesion: 0.15
Nodes (38): applicableFromBalance(), clampSplitAmount(), computeBalance(), LedgerEntry, LedgerType, num(), outstandingTotal(), requestHasOpenCl() (+30 more)
...
## Knowledge Gaps
- **3220 isolated node(s):** `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage`, `CRM`, `Contracts` (+3215 more)
...
- **Why does `CRM()` connect `GSAP Plugins` to `CRM.tsx / AccountsPage.tsx`, `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `DashboardHubSalesPerformancePage.tsx / DashboardHubSalesPerformancePa...`, `CRMProfileView.tsx`, `tailwindcss`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `formConfigurations.ts / AddAccountModal.tsx`, `GSAP Plugins`, `propertyOccupancyTypes.ts / calculateNights()`, `accountProfileData.ts`, `resolveCurrencyCode() / formatCurrencyAmount()`, `apiUrl() / backendApi.ts`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `dependencies` connect `contractsStore.ts / Contracts.tsx` to `package.json`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `apiUrl()` connect `buildVsLyMatrix` to `CRM.tsx / AccountsPage.tsx`, `AS.tsx / parseYmd()`, `contractsStore.ts / Contracts.tsx`, `GSAP Plugins`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `formConfigurations.ts / AddAccountModal.tsx`, `GSAP Plugins`, `apiUrl() / backendApi.ts`, `GSAP Plugins`, `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()`, `tailwindcss`, `@types/recharts`, `accountProfileData.ts`, `DashboardHubShell.tsx / dashboardHubTabs.ts`, `accountProfileData.ts`, `contactDisplayName`, `YearlyContractModal.tsx / YearlyContractModalProps`, `propertyPaymentMethods.ts`, `propertyAlertSettings.ts`?**
