...
## Corpus Check
- 805 files · ~1,245,520 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13044 nodes · 16039 edges · 779 communities (758 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.78)
...
2. `_get_pool()` - 86 edges
3. `RequestsManager()` - 67 edges
4. `apiUrl()` - 63 edges
5. `CRM()` - 60 edges
6. `AccountsPage()` - 46 edges
7. `cn()` - 43 edges
8. `require_user()` - 42 edges
9. `Settings()` - 39 edges
...
## Communities (779 total, 21 thin omitted)

### Community 0 - "CRM.tsx / AccountsPage.tsx"
Cohesion: 0.05
Nodes (75): checkPasswordPolicy(), DEADLINE_OFFSET_OPTIONS, DeadlineAlertKind, REQUEST_STATUS_OPTIONS, CALL_TYPE_REGISTRY, DEADLINE_CALL_KINDS, DeadlineCallKind, DeadlineCallRuleSettings (+67 more)

### Community 1 - "AS.tsx / parseYmd()"
Cohesion: 0.04
Nodes (100): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), accountPerformanceData, AccountsPage, AddAccountModal (+92 more)

### Community 2 - "crmCallReportUtils.ts / crmActivitiesUtils.ts"
Cohesion: 0.13
Nodes (33): CrmSalesPeriod, isCallDueToday(), parseYmdToLocalDate(), toLocalYmd(), buildCallReportChartBuckets(), buildCallReportExportFilename(), buildCallReportRows(), buildRowFromParts() (+25 more)

### Community 3 - "contractsStore.ts / Contracts.tsx"
Cohesion: 0.12
Nodes (47): Contracts(), ContractsProps, isCompanyNameVariable(), isDateLikeVariable(), isEndDateVariable(), isStartDateVariable(), isTodayVariable(), normalizeVarKey() (+39 more)
...
Cohesion: 0.07
Nodes (65): get_crm_state(), list_accounts(), _list_doc(), list_requests(), health(), on_startup(), Messenger group management + prefs smoke tests (Batch E/F)., Schema ensure is idempotent and adds Batch E/F columns. (+57 more)
...
Cohesion: 0.08
Nodes (48): ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS, DEADLINE_ALERT_KINDS, DeadlineAlertAccent, DeadlineAlertRuleSettings, DEFAULT_DEADLINE_ALERT_RULES, DEFAULT_ROW (+40 more)
...
Cohesion: 0.04
Nodes (89): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _assert_upsert_write_access(), _assert_write_access(), _broadcast_change(), _cascade_account_rename_to_requests() (+81 more)

### Community 13 - "RequestsManager.tsx / RequestsManager()"
Cohesion: 0.04
Nodes (109): requestMatchesAccount(), EventsView(), addCalendarDaysIso(), calculateAccFinancialsForRequest(), calculateEventAgendaDays(), calculateNights(), deriveBeoPaymentView(), deriveRequestMealLabelFromRooms() (+101 more)
...
Cohesion: 0.16
Nodes (33): addProratedRequestFinancialsToDashboardBuckets(), asNumberReport(), calculateNights(), chartStatusKeyFromRequest(), DashboardFinancialBucket, DashboardRoomsChartBucketGranularity, eachInclusiveAgendaDayYmd(), eachOccupiedNightYmd() (+25 more)
...
Cohesion: 0.09
Nodes (43): avg(), Card(), EmptyState(), FilterChips(), fmtCompact(), Hero(), inRange(), Meter() (+35 more)
...
Cohesion: 0.09
Nodes (23): class-variance-authority, docxtemplater, @fontsource-variable/geist, gsap, lucide-react, mammoth, dependencies, class-variance-authority (+15 more)
...
Cohesion: 0.14
Nodes (19): can_access_property(), Tenant isolation: a non-admin may only access assigned properties., Validate the requested property belongs to the user's tenant scope.      Retur, require_property_access(), auth_me(), change_password(), ChangePasswordRequest, _check_rate_limit() (+11 more)
...
Cohesion: 0.09
Nodes (34): CHAT_EMOJIS, playChatSound(), ChatWsMessage, Handler, setChatWsHandler(), ChatAvatar(), GroupInfoPanel(), Tab (+26 more)
...
Cohesion: 0.26
Nodes (14): delete_local_file(), _ext_of(), get_local_file(), _guess_media_type(), Path, UploadFile, Upload endpoints: local disk storage on the Docker volume (as-uploads-data)., Serve a previously uploaded file (auth required; cookie sent by <img>/<a>). (+6 more)
...
Cohesion: 0.06
Nodes (63): filterSalesCallsForAccount(), CRM(), CRM_QUARTER_MONTH_BLOCKS, crmLeadHasScheduledFollowUp(), CrmNavigateMeta, CRMProps, leadMatchesSalesPeriod(), resolveLeadAccountType() (+55 more)
...
Cohesion: 0.09
Nodes (36): LoadingState(), PropertyBadge(), AttachmentGallery(), attachmentKind(), Avatar(), colorsFallbackDim(), DashboardHubFeedPage(), FeedAttachment (+28 more)
...
Cohesion: 0.25
Nodes (7): Advanced Sales Dashboard — Agent Guide, Conventions, Layout, Local feature work (Docker Compose), Password migration (fresh Postgres), Production (when features are finalized), Stack
...
Cohesion: 0.06
Nodes (66): accountNameSortKey(), addAccountToContactIndex(), buildSystemDuplicateItems(), compareAccountNames(), findPotentialDuplicateAccounts(), isScanDuplicateQueueItemStale(), isScannedContactOnAccount(), normalizeAccountNameKey() (+58 more)
...
Cohesion: 0.12
Nodes (23): Badge(), badgeVariants, Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader() (+15 more)
...
Cohesion: 0.26
Nodes (35): delta, fmtInt(), fmtMoney(), fmtPct(), groupBy(), hexA(), legendStyle(), money() (+27 more)
...
Cohesion: 0.06
Nodes (59): AccountProfileChartRow, buildAccountProfileChartData(), buildDashboardAxis(), DashboardAxisGranularity, DashboardAxisPoint, getDashboardAxisKey(), getDefaultAccountPerformanceRange(), getMonthKey() (+51 more)
...
Cohesion: 0.06
Nodes (64): flattenCrmLeads(), AccountProfilePerformanceChart(), AccountsPageProps, MainChart(), convertCurrencyToSar(), convertSarToCurrency(), CURRENCY_OPTIONS, CurrencyCode (+56 more)
...
Cohesion: 0.15
Nodes (12): Checklist, Commands, Current state, Plan 036: Server status / health promote (ops), Scope, Status, Step 1: Enrich payload, Step 2: HTTP semantics (Ponytail pick one) (+4 more)
...
Cohesion: 0.10
Nodes (31): check(), _ck(), h(), Self-contained end-to-end test for write-path tenant isolation (IDOR), CRM/acco, run(), setup(), hash_password(), admin_pw_fixtures() (+23 more)
...
Cohesion: 0.08
Nodes (28): contrastOn(), RangeTabs(), DashboardHubComingSoonProps, DashboardHubAccountsPage, DashboardHubActivitiesPage, DashboardHubAgreementsPage, DashboardHubCrmPage, DashboardHubFeedPage (+20 more)
...
### Community 766 - "SKILL.md"
Cohesion: 0.24
Nodes (9): HERO_FEATURES, LandingPageTasteMotionPreview(), PRICING, Props, TEAMS, withAlpha(), Button(), buttonVariants (+1 more)

### Community 767 - "accountProfileChartData.ts"
Cohesion: 0.40
Nodes (5): Tabs(), TabsContent(), TabsList(), tabsListVariants, TabsTrigger()

### Community 769 - "contactDisplayName"
Cohesion: 0.67
Nodes (3): LandingPreviewGallery(), Props, withAlpha()
...
## Knowledge Gaps
- **8578 isolated node(s):** `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage`, `CRM`, `Contracts` (+8573 more)
...
- **Why does `dependencies` connect `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()` to `buildVsLyMatrix`, `contractsStore.ts / Contracts.tsx`, `crmPipelineCardRequestDetails.ts`, `1. THE THREE DIALS (Core Configuration)`, `propertyPaymentMethods.ts`, `normalizeRequestAlerts`, `package.json`, `recharts`, `shadcn`, `richText.tsx`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `CRM()` connect `MessengerWidget.tsx` to `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `formConfigurations.ts / AddAccountModal.tsx`, `agreementStatus`, `lucide-react`, `resolveCurrencyCode() / formatCurrencyAmount()`, `tw-animate-css`, `richText.tsx`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `apiUrl()` connect `buildVsLyMatrix` to `CRM.tsx / AccountsPage.tsx`, `AS.tsx / parseYmd()`, `contractsStore.ts / Contracts.tsx`, `chartVsYearCompare.ts / chartTabSupportsVs()`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `RequestsManager.tsx / RequestsManager()`, `SKILL.md`, `formConfigurations.ts / AddAccountModal.tsx`, `DashboardHubShell.tsx / dashboardHubTabs.ts`, `lucide-react`, `MessengerWidget.tsx`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`, `propertyOccupancyTypes.ts`, `AdvancedSalesDashboard() / alertDismissals.ts`?**
...
- **Are the 59 inferred relationships involving `_get_pool()` (e.g. with `bump_session_version_and_revoke()` and `change_password()`) actually correct?**
  _`_get_pool()` has 59 INFERRED edges - model-reasoned connections that need verification._
