# Graph Report - V3-Advanced-Sales  (2026-07-14)

## Corpus Check
- 744 files · ~1,201,811 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12246 nodes · 15008 edges · 731 communities (708 shown, 23 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 217 edges (avg confidence: 0.77)
...
- Per-component notes
- Per-component notes
- DashboardHubSalesPerformancePage.tsx
- GSAP Core
- GSAP Core
- GSAP Core
- GSAP Core
...
2. `_get_pool()` - 76 edges
3. `RequestsManager()` - 66 edges
4. `apiUrl()` - 63 edges
5. `CRM()` - 60 edges
6. `AccountsPage()` - 45 edges
7. `CORE DIRECTIVE: IMAGE-FIRST WEBSITE DESIGN TO CODE` - 39 edges
8. `CORE DIRECTIVE: PREMIUM MOBILE APP IMAGE DIRECTION` - 39 edges
9. `CORE DIRECTIVE: IMAGE-FIRST WEBSITE DESIGN TO CODE` - 39 edges
10. `CORE DIRECTIVE: PREMIUM MOBILE APP IMAGE DIRECTION` - 39 edges
...
## Communities (731 total, 23 thin omitted)
...
Cohesion: 0.03
Nodes (124): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), accountPerformanceData, AdvancedSalesDashboard(), AlertsBell (+116 more)
...
Cohesion: 0.06
Nodes (86): accountNameSortKey(), compareAccountNames(), findPotentialDuplicateAccounts(), isScanDuplicateQueueItemStale(), isScannedContactOnAccount(), normalizeAccountNameKey(), samePropertyAccount(), persistAccountMergeToBackend() (+78 more)
...
Cohesion: 0.08
Nodes (62): get_crm_state(), _list_doc(), get_current_user_ctx(), health(), on_startup(), _account_name_sort_key(), check_database_health(), _collection_key() (+54 more)
...
Cohesion: 0.14
Nodes (32): normalizeRequestTypeKey(), getDeadlineAlertRule(), isAlertKindActive(), mergePropertyAlertSettings(), SystemAlertKind, applyMessageTokens(), collectBeoStartDates(), collectCheckoutOrEndDates() (+24 more)
...
Cohesion: 0.04
Nodes (80): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _assert_write_access(), _broadcast_change(), _cascade_account_rename_to_requests(), _child_typed() (+72 more)

### Community 13 - "RequestsManager.tsx / RequestsManager()"
Cohesion: 0.04
Nodes (117): AccommodationRequestModal(), AccommodationRequestModalProps, mockLeads, requestMatchesAccount(), EventsView(), addCalendarDaysIso(), calculateAccFinancialsForRequest(), calculateEventAgendaDays() (+109 more)

### Community 14 - "formConfigurations.ts / AddAccountModal.tsx"
Cohesion: 0.25
Nodes (16): Card(), delta, EmptyState(), FilterChips(), fmtPct(), groupBy(), Hero(), MiniStat() (+8 more)
...
Cohesion: 0.11
Nodes (25): CrmSalesPeriod, defaultPipelineBuckets(), filterPipelineForProperty(), Card(), KPICard(), MiniStatCard(), StatusBadge(), buildDemoAccounts() (+17 more)

### Community 17 - "beoShared.ts / EventsView()"
Cohesion: 0.11
Nodes (36): DEFAULT_MEAL_PLANS, dispatchChanged(), EVENT_PACKAGE_TIMING_OPTIONS, EventPackageEntry, eventPackagesFromArray(), eventPackagesKey(), EventPackageTimingId, getTimingSlotsForTimingId() (+28 more)

### Community 18 - "feed.py / dependencies.py"
Cohesion: 0.07
Nodes (66): is_admin(), require_user(), add_participants(), _assert_participant(), _broadcast_chat(), _can_message(), create_group(), create_or_get_dm() (+58 more)
...
Cohesion: 0.08
Nodes (42): LoadingState(), PropertyBadge(), AttachmentGallery(), attachmentKind(), Avatar(), colorsFallbackDim(), DashboardHubFeedPage(), FeedAttachment (+34 more)

### Community 22 - "CRMProfileView.tsx / accountProfileData.ts"
Cohesion: 0.15
Nodes (33): buildMirrorSalesCallFromPipelineCard(), cardPeriodMonth(), clearPipelineLinkForDeletedRequest(), clonePipeline(), CrmStatePayload, defaultCrmState(), filterSalesCallsForProperty(), findMonthlyPipelineCard() (+25 more)
...
Cohesion: 0.06
Nodes (87): requestTouchesOperationalDateRange(), ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS, DEADLINE_ALERT_KINDS, DEADLINE_OFFSET_OPTIONS, DeadlineAlertAccent, DeadlineAlertKind (+79 more)
...
Cohesion: 0.07
Nodes (77): ACCOUNT_TYPE_LABEL_SYNONYMS, accountTypesKey(), DEFAULT_PROPERTY_ACCOUNT_TYPES, DEFAULT_PROPERTY_SEGMENTS, loadAccountTypesForProperty(), loadSegmentsForProperty(), matchRawToPropertyLabel(), normalizeTaxonomyStringList() (+69 more)
...
Cohesion: 0.09
Nodes (23): class-variance-authority, docxtemplater, @fontsource-variable/geist, gsap, @gsap/react, jspdf-autotable, mammoth, dependencies (+15 more)
...
Cohesion: 0.14
Nodes (14): DashboardHubShellProps, DashboardHubTabBarProps, DASHBOARD_HUB_TABS, DashboardHubTabDef, DashboardHubTabId, dashboardHubTabLabel(), isDashboardHubTabLive(), HubData (+6 more)
...
Cohesion: 0.11
Nodes (22): get_current_user(), Any, Server-side auth dependencies: session resolution, permission + tenant enforceme, require_admin(), set_current_user(), auth_context_and_security_headers(), _database_host(), global_exception_handler() (+14 more)
...
Cohesion: 0.30
Nodes (26): fmtCompact(), fmtInt(), fmtMoney(), hexA(), inRange(), legendStyle(), money(), monthKey() (+18 more)
...
Cohesion: 0.18
Nodes (12): CHAT_EMOJIS, playChatSound(), ChatWsMessage, dispatchChatWs(), Handler, setChatWsHandler(), ChatConversation, ChatMessage (+4 more)
...
Cohesion: 0.39
Nodes (8): rangeBounds(), useRangeBounds(), DashboardHubSalesPerformancePage(), isLost(), isWon(), money(), normStatus(), resolveUserKey()
...
Cohesion: 0.04
Nodes (92): AccountLinkedRequestsModal(), AccountLinkedRequestsModalProps, AccountProfileChartRow, getDefaultAccountPerformanceRange(), buildAccountTimeline(), computeAccountMetrics(), filterInquiryToTentativeRequests(), filterOpenBookingRequests() (+84 more)
...
### Community 229 - "LogCallModal.tsx"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (25): Card(), CardAction(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), Input() (+17 more)

### Community 257 - "Login.tsx"
Cohesion: 0.06
Nodes (62): accountToLead(), contactDisplayName(), leadToAccount(), mergeAccountIntoCrmLead(), resolveAccountOwnerName(), withContactName(), AccountMergeApplyInput, applyAccountMergeInMemory() (+54 more)
...
### Community 718 - "package.json"
Cohesion: 0.15
Nodes (14): HERO_FEATURES, LandingPageTasteMotionPreview(), PRICING, Props, TEAMS, withAlpha(), LandingPreviewGallery(), Props (+6 more)
...
## Knowledge Gaps
- **8063 isolated node(s):** `THEMES`, `DASHBOARD_PERIOD_MODES`, `DashboardPeriodMode`, `MONTH_SHORT`, `DashboardAxisGranularity` (+8058 more)
...
- **Why does `dependencies` connect `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()` to `accounts.py`, `contractsStore.ts / Contracts.tsx`, `react-dom`, `agreementStatus`, `1. THE THREE DIALS (Core Configuration)`, `SKILL.md`, `lucide-react`, `DashboardHubSalesPerformancePage.tsx`, `shadcn`, `tailwind-merge`, `tw-animate-css`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `CRM()` connect `Login.tsx` to `CRM.tsx / AccountsPage.tsx`, `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()`, `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `AS.tsx / parseYmd()`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `buildVsLyMatrix`, `CRMProfileView.tsx / accountProfileData.ts`, `resolveCurrencyCode() / formatCurrencyAmount()`, `apiUrl() / backendApi.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `apiUrl()` connect `contractsStore.ts / Contracts.tsx` to `CRM.tsx / AccountsPage.tsx`, `Login.tsx`, `AS.tsx / parseYmd()`, `chartVsYearCompare.ts / chartTabSupportsVs()`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `DashboardHubShell.tsx / dashboardHubTabs.ts`, `beoShared.ts / EventsView()`, `propertyOccupancyTypes.ts / calculateNights()`, `MessengerWidget.tsx`, `apiUrl() / backendApi.ts`, `AdvancedSalesDashboard() / alertDismissals.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
...
- **Are the 49 inferred relationships involving `_get_pool()` (e.g. with `bump_session_version_and_revoke()` and `change_password()`) actually correct?**
  _`_get_pool()` has 49 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `THEMES`, `DASHBOARD_PERIOD_MODES`, `DashboardPeriodMode` to the rest of the system?**
  _8063 weakly-connected nodes found - possible documentation gaps or missing edges._