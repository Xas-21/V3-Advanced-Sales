...
## Corpus Check
- 800 files · ~1,244,373 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12925 nodes · 16112 edges · 766 communities (751 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 250 edges (avg confidence: 0.77)
...
## Communities (766 total, 15 thin omitted)

### Community 0 - "CRM.tsx / AccountsPage.tsx"
Cohesion: 0.08
Nodes (45): ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS, DEADLINE_ALERT_KINDS, DEADLINE_OFFSET_OPTIONS, DeadlineAlertAccent, DeadlineAlertKind, DeadlineAlertRuleSettings (+37 more)

### Community 1 - "AS.tsx / parseYmd()"
Cohesion: 0.03
Nodes (143): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), accountPerformanceData, AccountsPage, AddAccountModal (+135 more)
...
Cohesion: 0.16
Nodes (38): Contracts(), ContractsProps, isCompanyNameVariable(), isDateLikeVariable(), isEndDateVariable(), isStartDateVariable(), isTodayVariable(), normalizeVarKey() (+30 more)
...
Cohesion: 0.08
Nodes (63): get_crm_state(), _list_doc(), health(), on_startup(), Schema ensure is idempotent and adds Batch E/F columns., test_ensure_chat_tables_columns(), _account_name_sort_key(), check_database_health() (+55 more)
...
Cohesion: 0.15
Nodes (31): getEventDateWindow(), normalizeRequestTypeKey(), isAlertKindActive(), SystemAlertKind, applyMessageTokens(), collectBeoStartDates(), collectCheckoutOrEndDates(), collectGisArrivalDates() (+23 more)
...
Cohesion: 0.04
Nodes (88): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _assert_write_access(), _broadcast_change(), _cascade_account_rename_to_requests(), _child_typed() (+80 more)

### Community 13 - "RequestsManager.tsx / RequestsManager()"
Cohesion: 0.09
Nodes (56): requestMatchesAccount(), EventsView(), addCalendarDaysIso(), calculateAccFinancialsForRequest(), deriveBeoPaymentView(), deriveRequestMealLabelFromRooms(), escapeHtml(), expandAgendaRowVenueOccupancies() (+48 more)

### Community 14 - "formConfigurations.ts / AddAccountModal.tsx"
Cohesion: 0.14
Nodes (25): applyFormOverrideToSchema(), clone(), collectAccountFormViolations(), collectContactFormViolations(), collectNewPropertyFormViolations(), collectNewUserFormViolations(), collectRequestFormViolations(), FORM_CONFIGURATION_META (+17 more)
...
Cohesion: 0.16
Nodes (37): addProratedRequestFinancialsToDashboardBuckets(), asNumberReport(), buildReportSegmentsForRequest(), calculateNights(), computeRequestRevenueBreakdownNoTax(), DashboardFinancialBucket, DashboardRoomsChartBucketGranularity, eachInclusiveAgendaDayYmd() (+29 more)
...
Cohesion: 0.05
Nodes (41): class-variance-authority, clsx, docxtemplater, @fontsource-variable/geist, gsap, @gsap/react, jspdf, jspdf-autotable (+33 more)
...
Cohesion: 0.19
Nodes (16): useMessenger(), ChatAvatar(), chatInitials(), formatMsgTime(), messageIsReadByPeer(), MessengerFab(), MessengerPopup(), prefersReducedMotion() (+8 more)
...
Cohesion: 0.31
Nodes (9): calculateEventAgendaDays(), calculateNights(), countRequestNights(), countRequestRooms(), getRequestCreatorName(), getRequestKanbanCardDetails(), PipelineLinkedRequestDisplay, RequestCardDeadline (+1 more)
...
Cohesion: 0.11
Nodes (29): flattenCrmLeads(), convertCurrencyToSar(), inDateRangeYMD(), ReportSegment, requestOperationalDatesOverlapRange(), segmentLineTotalExTax(), csvEscape(), defaultMonthRange() (+21 more)
...
Cohesion: 0.06
Nodes (64): AccountLinkedRequestsModal(), AccountLinkedRequestsModalProps, filterRequestsForAccount(), AccountsPageProps, AddSalesCallModal(), MainChart(), CRM(), CRM_QUARTER_MONTH_BLOCKS (+56 more)
...
Cohesion: 0.07
Nodes (65): accountNameSortKey(), addAccountToContactIndex(), buildSystemDuplicateItems(), compareAccountNames(), findPotentialDuplicateAccounts(), isScanDuplicateQueueItemStale(), isScannedContactOnAccount(), normalizeAccountNameKey() (+57 more)
...
Cohesion: 0.07
Nodes (54): AccountProfileChartRow, buildAccountProfileChartData(), buildDashboardAxis(), DashboardAxisGranularity, DashboardAxisPoint, getDashboardAxisKey(), getDefaultAccountPerformanceRange(), getMonthKey() (+46 more)
...
### Community 738 - "requestDetailLayout.ts"
Cohesion: 0.53
...
## Knowledge Gaps
- **8491 isolated node(s):** `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage`, `CRM`, `Contracts` (+8486 more)
...
- **Why does `apiUrl()` connect `AdvancedSalesDashboard() / alertDismissals.ts` to `CRM.tsx / AccountsPage.tsx`, `AS.tsx / parseYmd()`, `Login.tsx`, `contractsStore.ts / Contracts.tsx`, `package.json`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `formConfigurations.ts / AddAccountModal.tsx`, `SKILL.md`, `DashboardHubShell.tsx / dashboardHubTabs.ts`, `agreementStatus`, `MessengerWidget.tsx`, `pizzip`, `tw-animate-css`, `propertyOccupancyTypes.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
- **Why does `CRM()` connect `Login.tsx` to `CRM.tsx / AccountsPage.tsx`, `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()`, `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `AS.tsx / parseYmd()`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `agreementStatus`, `propertyOccupancyTypes.ts / calculateNights()`, `resolveCurrencyCode() / formatCurrencyAmount()`, `apiUrl() / backendApi.ts`, `requestDetailLayout.ts / includesEventAgendaSection()`, `AdvancedSalesDashboard() / alertDismissals.ts`?**
  _High betweenness centrality (0.002) - this node is a cross-community bridge._
...
- **What connects `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage` to the rest of the system?**
  _8491 weakly-connected nodes found - possible documentation gaps or missing edges._