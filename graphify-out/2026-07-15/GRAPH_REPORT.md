# Graph Report - V3-Advanced-Sales  (2026-07-15)

## Corpus Check
- 798 files · ~1,239,209 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12892 nodes · 15997 edges · 764 communities (750 shown, 14 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 232 edges (avg confidence: 0.77)
...
2. `_get_pool()` - 77 edges
3. `apiUrl()` - 69 edges
4. `RequestsManager()` - 66 edges
5. `CRM()` - 60 edges
6. `AccountsPage()` - 46 edges
7. `hexA()` - 44 edges
8. `useHubData()` - 39 edges
9. `fmtInt()` - 39 edges
10. `cn()` - 39 edges
...
## Communities (764 total, 14 thin omitted)

### Community 0 - "CRM.tsx / AccountsPage.tsx"
Cohesion: 0.09
Nodes (31): FORM_CONFIGURATION_META, FormConfigurationFormId, FormOverride, PropertyFormConfigStore, DEADLINE_ALERT_KINDS, DEADLINE_OFFSET_OPTIONS, REQUEST_STATUS_OPTIONS, CALL_TYPE_REGISTRY (+23 more)

### Community 1 - "AS.tsx / parseYmd()"
Cohesion: 0.03
Nodes (132): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), accountPerformanceData, AccountsPage, AddAccountModal (+124 more)

### Community 2 - "crmCallReportUtils.ts / crmActivitiesUtils.ts"
Cohesion: 0.09
Nodes (60): CallDetailsModal(), CallDetailsModalProps, kindLabel(), accountHasCallHistory(), buildAccountCallTimeline(), CallTimelineEntry, CRM_QUARTER_MONTH_BLOCKS, CrmSalesPeriod (+52 more)
...
Cohesion: 0.08
Nodes (65): get_account(), get_crm_state(), list_accounts(), _list_doc(), _load_users_cache(), _row_to_account_dict(), health(), on_startup() (+57 more)

### Community 7 - "auth_db.py / security.py"
Cohesion: 0.04
Nodes (47): authenticate(), bump_session_version_and_revoke(), change_password(), create_session(), get_password_hash(), get_user_by_id(), get_user_by_username(), AS authentication + authorization + tenant isolation against the relational DB. (+39 more)
...
Cohesion: 0.05
Nodes (40): autoprefixer, devDependencies, autoprefixer, postcss, tailwindcss, @types/node, @types/react, @types/react-dom (+32 more)

### Community 12 - "list_flat() / upsert_flat()"
Cohesion: 0.04
Nodes (83): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _assert_write_access(), _broadcast_change(), _cascade_account_rename_to_requests(), _child_typed() (+75 more)

### Community 13 - "RequestsManager.tsx / RequestsManager()"
Cohesion: 0.05
Nodes (99): EventsView(), formatMiceAgendaDateRange(), getMiceRequestDateWindow(), rangesOverlap(), requestInEventDateRange(), requestToKanbanCard(), statusToColumnId(), totalMiceRequestAttendeeDays() (+91 more)

### Community 14 - "formConfigurations.ts / AddAccountModal.tsx"
Cohesion: 0.13
Nodes (32): accountToFormState(), AddAccountModal(), AddAccountModalProps, defaultFormState(), emptyContactRow(), AddSalesCallModal(), AddSalesCallModalProps, applyFormOverrideToSchema() (+24 more)
...
Cohesion: 0.18
Nodes (28): is_admin(), add_participants(), _assert_participant(), _broadcast_chat(), _can_message(), create_group(), create_or_get_dm(), _default_property_id() (+20 more)
...
Cohesion: 0.10
Nodes (52): buildAccountProfileChartData(), buildDashboardAxis(), DashboardAxisGranularity, DashboardAxisPoint, getDashboardAxisKey(), getMonthKey(), isDashboardExcludedRequest(), isEventsCateringEligibleRequest() (+44 more)
...
Cohesion: 0.05
Nodes (144): API_ORIGIN, apiUrl(), Card(), contrastOn(), delta, EmptyState(), FilterChips(), fmtCompact() (+136 more)
...
Cohesion: 0.05
Nodes (42): class-variance-authority, clsx, parseVariablesFromDocxBytes(), docxtemplater, @fontsource-variable/geist, gsap, @gsap/react, jspdf (+34 more)
...
Cohesion: 0.15
Nodes (21): AttachmentGallery(), deleteFileLocal(), LocalUploadResult, mediaUrl(), parseErrorText(), uploadFileLocal(), useMessenger(), ChatAvatar() (+13 more)
...
Cohesion: 0.20
Nodes (15): get_current_user(), get_current_user_ctx(), Any, Server-side auth dependencies: session resolution, permission + tenant enforceme, Prefer middleware-set context; fall back to resolve_session for rare paths witho, require_admin(), _user_from_ctx_or_session(), create_or_update_user() (+7 more)
...
Cohesion: 0.15
Nodes (20): ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS, DeadlineAlertAccent, DeadlineAlertKind, DeadlineAlertRuleSettings, DEFAULT_DEADLINE_ALERT_RULES, DEFAULT_ROW (+12 more)
...
Cohesion: 0.07
Nodes (52): AccountProfileChartRow, flattenCrmLeads(), ACCOUNT_PROFILE_CHART_TABS, AccountProfileChartTab, AccountProfilePerformanceChart(), LY_COLORS, Props, rechartsTooltipThemeProps() (+44 more)
...
Cohesion: 0.07
Nodes (40): HERO_FEATURES, LandingPageTasteMotionPreview(), PRICING, Props, TEAMS, withAlpha(), LandingPreviewGallery(), Props (+32 more)

### Community 257 - "Login.tsx"
Cohesion: 0.09
Nodes (45): accountToLead(), contactDisplayName(), leadToAccount(), mergeAccountIntoCrmLead(), resolveAccountOwnerName(), withContactName(), AccountMergeApplyInput, applyAccountMergeInMemory() (+37 more)
...
Cohesion: 0.40
Nodes (4): Cross-tab overlaps, Hub tabs — duplicated KPIs / charts audit, Ownership (recommended after you pick previews), Within-tab duplicates (originals)
...
Cohesion: 0.17
Nodes (13): CHAT_EMOJIS, playChatSound(), ChatWsMessage, dispatchChatWs(), Handler, setChatWsHandler(), ChatConversation, ChatMessage (+5 more)
...
Cohesion: 0.08
Nodes (43): AccountLinkedRequestsModal(), AccountLinkedRequestsModalProps, getDefaultAccountPerformanceRange(), AccountRequestStats, buildAccountTimeline(), buildRequestStatsByAccount(), computeAccountMetrics(), filterInquiryToTentativeRequests() (+35 more)
...
Cohesion: 0.36
Nodes (7): _any_property_id(), flat_authz_fixtures(), Flat list tenant isolation (plan 005): non-admins must not read other properties, Home property (existing) + foreign property + scoped non-admin + foreign task., _session_cookie(), test_scoped_user_cannot_list_foreign_property_tasks(), test_scoped_user_unscoped_tasks_omit_foreign()
...
Cohesion: 0.09
Nodes (21): Advisor plans index, Audit coverage note, Batch A — API / Docker / lazy load (DONE), Batch B — Accounts + Settings profile lag (NEW), Batch B — considered and rejected (Ponytail), Batch C — considered and rejected (Ponytail), Batch C — Messenger readability + redesign (NEW), Batch D — considered and rejected (Ponytail) (+13 more)
...
### Community 769 - "1. THE THREE DIALS (Core Configuration)"
Cohesion: 0.50
Nodes (4): 1.A Dial Inference (design read → dial values), 1.B Use-Case Presets, 1.C How the Dials Drive Output, 1. THE THREE DIALS (Core Configuration)

## Knowledge Gaps
- **8493 isolated node(s):** `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage`, `CRM`, `Contracts` (+8488 more)
...
- **Why does `apiUrl()` connect `AdvancedSalesDashboard() / alertDismissals.ts` to `CRM.tsx / AccountsPage.tsx`, `Login.tsx`, `AS.tsx / parseYmd()`, `contractsStore.ts / Contracts.tsx`, `package.json`, `chartVsYearCompare.ts / chartTabSupportsVs()`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `formConfigurations.ts / AddAccountModal.tsx`, `SKILL.md`, `DashboardHubShell.tsx / dashboardHubTabs.ts`, `agreementStatus`, `MessengerWidget.tsx`, `pizzip`, `requestDetailLayout.ts / includesEventAgendaSection()`, `propertyOccupancyTypes.ts`, `tw-animate-css`?**
  _High betweenness centrality (0.003) - this node is a cross-community bridge._
- **Why does `CRM()` connect `Login.tsx` to `CRM.tsx / AccountsPage.tsx`, `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()`, `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `AS.tsx / parseYmd()`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `buildVsLyMatrix`, `RequestsManager.tsx / RequestsManager()`, `formConfigurations.ts / AddAccountModal.tsx`, `agreementStatus`, `propertyOccupancyTypes.ts / calculateNights()`, `lucide-react`, `resolveCurrencyCode() / formatCurrencyAmount()`, `apiUrl() / backendApi.ts`, `AdvancedSalesDashboard() / alertDismissals.ts`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **Why does `dependencies` connect `DashboardHubRequestsPage.tsx / DashboardHubRequestsPage()` to `MessengerWidget.tsx`, `scripts / devDependencies`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
...
- **Are the 50 inferred relationships involving `_get_pool()` (e.g. with `bump_session_version_and_revoke()` and `change_password()`) actually correct?**
  _`_get_pool()` has 50 INFERRED edges - model-reasoned connections that need verification._
...
- **What connects `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage` to the rest of the system?**
  _8493 weakly-connected nodes found - possible documentation gaps or missing edges._