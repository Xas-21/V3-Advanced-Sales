# Graph Report - new-request-discard-draft  (2026-07-21)

## Corpus Check
- 481 files · ~660,843 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6203 nodes · 10087 edges · 451 communities (429 shown, 22 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 366 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e5e7ec68`
...
Cohesion: 0.06
Nodes (58): checkPasswordPolicy(), DEADLINE_ALERT_KINDS, DEADLINE_OFFSET_OPTIONS, DeadlineAlertKind, REQUEST_STATUS_OPTIONS, CALL_TYPE_REGISTRY, DEADLINE_CALL_KINDS, DeadlineCallKind (+50 more)

### Community 1 - "AS.tsx / parseYmd()"
Cohesion: 0.05
Nodes (75): dismissStorageKey(), isDismissedForDate(), loadDismissMap(), localDateKey(), saveDismissMap(), APP_VIEW_PATHS, HUB_TAB_IDS, isHubTabId() (+67 more)

### Community 2 - "crmCallReportUtils.ts / crmActivitiesUtils.ts"
Cohesion: 0.13
Nodes (21): mediaUrl(), CHAT_EMOJIS, playChatSound(), ChatWsMessage, dispatchChatWs(), Handler, setChatWsHandler(), ChatAvatar() (+13 more)

### Community 3 - "contractsStore.ts / Contracts.tsx"
Cohesion: 0.18
Nodes (28): attachSignedContractFile(), autoExpire(), deleteContractRecord(), deleteContractTemplate(), dispatchContractsChanged(), formatDateLong(), formatDateYmd(), fromBase64() (+20 more)
...
Cohesion: 0.07
Nodes (70): get_account(), get_crm_state(), _list_doc(), list_requests(), health(), on_startup(), Schema ensure is idempotent and adds Batch E/F columns., test_ensure_chat_tables_columns() (+62 more)

### Community 7 - "auth_db.py / security.py"
Cohesion: 0.15
Nodes (21): AttachmentGallery(), attachmentKind(), Avatar(), colorsFallbackDim(), DashboardHubFeedPage(), FeedAttachment, FeedCard(), FeedComment (+13 more)

### Community 8 - "requestAlertEngine.ts / propertyAlertSettings.ts"
Cohesion: 0.22
Nodes (10): DIST_BAR_PALETTE_KEYS, DistributionChart(), DistributionChartProps, MainChart(), MainChartProps, ChartLegend(), ChartLegendPayloadItem, rechartsTooltipThemeProps() (+2 more)
...
Cohesion: 0.13
Nodes (15): eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, devDependencies, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, @types/node (+7 more)
...
Cohesion: 0.11
Nodes (35): accountToFormState(), AddAccountModal(), AddAccountModalProps, defaultFormState(), emptyContactRow(), AddSalesCallModal(), AddSalesCallModalProps, applyFormOverrideToSchema() (+27 more)
...
Cohesion: 0.08
Nodes (47): AccountProfileChartRow, getDefaultAccountPerformanceRange(), AccountRequestStats, buildAccountTimeline(), buildRequestStatsByAccount(), computeAccountMetrics(), filterInquiryToTentativeRequests(), filterOpenBookingRequests() (+39 more)

### Community 22 - "CRMProfileView.tsx / accountProfileData.ts"
Cohesion: 0.11
Nodes (39): asNumber(), bucketYmdForRequest(), buildCoreRow(), buildSegMaps(), calculateNights(), calculateRoomBlockForReport(), computeMiceChartRevenueInMonth(), computeRequestRevenueBreakdownNoTax() (+31 more)
...
Cohesion: 0.11
Nodes (32): accountNameSortKey(), addAccountToContactIndex(), buildSystemDuplicateItems(), compareAccountNames(), findPotentialDuplicateAccounts(), isScanDuplicateQueueItemStale(), isScannedContactOnAccount(), normalizeAccountNameKey() (+24 more)
...
Cohesion: 0.22
Nodes (17): Contracts(), ContractsProps, isCompanyNameVariable(), isDateLikeVariable(), isEndDateVariable(), isStartDateVariable(), isTodayVariable(), normalizeVarKey() (+9 more)
...
Cohesion: 0.08
Nodes (51): AlertsBell, AlertsBellProps, normalizeRequestTypeKey(), shouldIncludeRequestInRoomsChart(), ALERT_TYPE_REGISTRY, AlertKindRowSettings, DEADLINE_ACCENT_OPTIONS, DeadlineAlertAccent (+43 more)
...
Cohesion: 0.09
Nodes (25): build_cors_settings(), _expand_www_variants(), _normalize_origin(), ProductionCORSMiddleware, CORS middleware with Render-friendly origin fallbacks., Browser Origin headers never include a path or trailing slash., Allow both apex and www for real custom domains only.      IP addresses (e.g., Accept configured origins/regex plus any https://*.onrender.com host. (+17 more)
...
Cohesion: 0.21
Nodes (21): buildFullVsLyMatrix(), buildGrandHotelCombinedRevenueRow(), buildOtherRevenueRow(), buildSegmentCountRows(), buildSegmentRevenueRows(), buildVsLyMatrix(), collectRequestsTouchingMonth(), filterTypeRooms() (+13 more)
...
Cohesion: 0.05
Nodes (39): class-variance-authority, clsx, docxtemplater, @fontsource-variable/geist, gsap, @gsap/react, jspdf, jspdf-autotable (+31 more)
...
Cohesion: 0.14
Nodes (23): inDateRangeYMD(), segmentLineTotalExTax(), csvEscape(), defaultMonthRange(), formatSar(), initialSavedReports, isEventOrEventRoomsType(), lineAmountsExTaxToWithTax() (+15 more)
...
Cohesion: 0.07
Nodes (79): isClPaymentMethod(), e(), contactDisplayName(), leadToAccount(), withContactName(), requestMatchesAccount(), addCalendarDaysIso(), calculateAccFinancialsForRequest() (+71 more)
...
Cohesion: 0.16
Nodes (26): _as_date(), _as_datetime(), _as_decimal(), _as_int(), _cascade_account_rename_to_requests(), _child_typed(), _extract_account_ledger(), _extract_account_rates() (+18 more)
...
Cohesion: 0.14
Nodes (22): is_admin(), get_current_user(), get_current_user_ctx(), Any, Server-side auth dependencies: session resolution, permission + tenant enforceme, Prefer middleware-set context; fall back to resolve_session for rare paths witho, require_admin(), set_current_user() (+14 more)
...
Cohesion: 0.11
Nodes (28): ALLOWED_ATTR, ALLOWED_TAGS, extractMentionIds(), htmlToPlainText(), MentionUser, RichContent(), RichTextEditor, RichTextEditorHandle (+20 more)
...
Cohesion: 0.64
Nodes (6): coerceMoneyNumber(), formatCompactAmount(), formatCompactCurrency(), formatCompactSar(), formatMillionMantissa(), formatScaledUnit()

### Community 273 - "GSAP Plugins"
Cohesion: 0.06
Nodes (54): setup(), hash_password(), _any_property_id(), ledger_fixtures(), account_ledger API: sign normalization, accountId filter, transfer, tenant guard, _session_cookie(), _table_ready(), _any_property_id() (+46 more)
...
Cohesion: 0.20
Nodes (12): delete_account(), list_accounts(), AccountSyncBody, AccountUpsertBody, delete_account_endpoint(), get_account_endpoint(), list_accounts_endpoint(), BaseModel (+4 more)
...
Cohesion: 0.15
Nodes (21): _assert_upsert_write_access(), _assert_write_access(), _broadcast_change(), delete_request(), get_public_feedback_by_token(), Broadcast a data mutation event to WebSocket clients.          Args:, Enforce tenant isolation on writes/deletes, symmetric with read scoping., Explicit public opt-in: load feedback form by publicToken without auth.      D (+13 more)
...
Cohesion: 0.08
Nodes (42): accountToLead(), mergeAccountIntoCrmLead(), resolveAccountOwnerName(), AccountLinkedRequestsModal(), AccountLinkedRequestsModalProps, filterRequestsForAccount(), filterSalesCallsForAccount(), AccountsPageProps (+34 more)
...
Cohesion: 0.14
Nodes (13): Commits, Concerns, Implementation summary, Manual smoke (brief Step 7), Self-review, Status, Step 1 — Import, Step 2 — Handler (+5 more)

### Community 294 - "propertyOccupancyTypes.ts"
Cohesion: 0.17
Nodes (11): Commands Run, Concerns, Files Changed, GREEN — Step 4 (after implementation), Implementation, Next Task, RED — Step 2 (tests before implementation), Self-Review (+3 more)
...
Cohesion: 0.46
Nodes (6): clearNewRequestDraft(), confirmDiscardNewRequestDraft(), NewRequestDraft, readNewRequestDraft(), seedDraft(), writeNewRequestDraft()
...
Cohesion: 0.09
Nodes (62): CallDetailsModal(), CallDetailsModalProps, kindLabel(), accountHasCallHistory(), buildAccountCallTimeline(), CallTimelineEntry, CRM_QUARTER_MONTH_BLOCKS, CrmSalesPeriod (+54 more)
...
Cohesion: 0.20
Nodes (18): convertCurrencyToSar(), convertSarToCurrency(), CURRENCY_OPTIONS, formatCurrencyAmount(), getCurrencySymbol(), resolveCurrencyCode(), SAR_PER_CURRENCY, formatSarCompact() (+10 more)

### Community 313 - "pizzip"
Cohesion: 0.13
Nodes (22): CardExtractResponse, deleteAccountDuplicateQueueItem(), extractBusinessCard(), listAccountDuplicateQueue(), upsertAccountDuplicateQueueItem(), API_ORIGIN, apiUrl(), LandingPage() (+14 more)
...
### Community 319 - "test_patch_user_property_id_preserves_session_version"
Cohesion: 0.48
Nodes (5): normalizeRequestAlerts(), RequestAlert, requestHasAlerts(), RequestAlertsModal(), RequestAlertsModalProps

### Community 320 - "eslint"
Cohesion: 0.53
Nodes (4): expectedEventAgendaSectionCount(), includesEventAgendaSection(), logRequestDetailEventAgendaRender(), REQUEST_DETAIL_EVENT_AGENDA_SECTION_KEY

### Community 329 - "task-2-review-package.md"
Cohesion: 0.50
Nodes (3): Commits, Diff, Stat
...
## Knowledge Gaps
- **3320 isolated node(s):** `LandingPage`, `LandingPageTasteMotionPreview`, `RequestFeedbackPublicPage`, `CRM`, `Contracts` (+3315 more)
...
- **Why does `apiUrl()` connect `pizzip` to `CRM.tsx / AccountsPage.tsx`, `AS.tsx / parseYmd()`, `crmCallReportUtils.ts / crmActivitiesUtils.ts`, `contractsStore.ts / Contracts.tsx`, `auth_db.py / security.py`, `formConfigurations.ts / AddAccountModal.tsx`, `GSAP Plugins`, `apiUrl() / backendApi.ts`, `GSAP Plugins`, `AdvancedSalesDashboard() / alertDismissals.ts`, `test_admin_password_reset.py`, `CRMProfileView.tsx`, `tailwindcss`, `accountProfileData.ts`, `accountProfileData.ts`, `MICEContractModal.tsx / MICEContractModalProps`, `YearlyContractModal.tsx / YearlyContractModalProps`, `propertyPaymentMethods.ts`, `propertyAlertSettings.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `CRM()` connect `GSAP Plugins` to `DashboardHubSalesPerformancePage.tsx / DashboardHubSalesPerformancePa...`, `contractsStore.ts / Contracts.tsx`, `CRMProfileView.tsx`, `tailwindcss`, `requestAlertEngine.ts / propertyAlertSettings.ts`, `1. THE THREE DIALS (Core Configuration)`, `RequestsManager.tsx / RequestsManager()`, `GSAP Plugins`, `cors_middleware.py / _normalize_origin()`, `test_patch_user_property_id_preserves_session_version`, `resolveCurrencyCode() / formatCurrencyAmount()`, `propertyOccupancyTypes.ts / calculateNights()`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`, `accountProfileData.ts`, `pizzip`, `propertyPaymentMethods.ts`, `test_admin_password_reset.py`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `dependencies` connect `cors_middleware.py / _normalize_origin()` to `package.json`, `DashboardHubComingSoon.tsx / DashboardHubComingSoonProps`, `GSAP Plugins`?**
